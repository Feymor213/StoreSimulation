...
migrate((app) => {
  const snapshot = [
    ...
    },
    {
      ...
      "fields": [
        {
          "autogeneratePattern": "[1-9][0-9]{14}",
          "hidden": false,
          "id": "text3208210256",
          "max": 15,
          "min": 15,
    ...
    },
    {
      ...
      "fields": [
        ...
        {
          "cascadeDelete": false,
          "collectionId": "pbc_3406759132",
          "hidden": false,
          "id": "relation1649626657",
          "maxSelect": 999,
          "minSelect": 0,
          "name": "customers",
          "presentable": false,
    ...
    },
    {
      ...
      "id": "pbc_2061535217",
      "indexes": [
        "CREATE UNIQUE INDEX `interest_category_customer_idx` ON `interestsCategory` (\n  `category`,\n  `customer`\n)"
      ],
      "listRule": null,
